...
| `storage` | `github.com/shepard-labs/go-clients/storage` | GCS (`/gcs`), Cloudflare R2 (`/r2`), S3-compatible (`/s3`: AWS S3, MinIO, Backblaze B2, Wasabi, GCS-HMAC), local filesystem (`/local`) |
